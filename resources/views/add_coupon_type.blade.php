...
{  
 ...
 // $result=$urlspd.$newname;
  ...
  { 
      ...
      $query = "insert into coupon_type set name='".$name."',image='".$newname."'";
      if(mysqli_query($conn,$query))
      {
          //copy($temp,"img/products/".$newname);
          echo '<script>alert("Coupon Type Add Successfully");</script>';
