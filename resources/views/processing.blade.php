...
{  
   ...
   $deliveryman=trim($_POST['deliveryman']);
      ...
      $query = "update orders set paymentStatus='".$paymentStatus."',orderStatus='".$orderStatus."',deliveryman='".$deliveryman."',order_otp='".$otp."' where orderId='".$id."'";
      if(mysqli_query($conn,$query))
      {
          //copy($temp,"img/products/".$newname);
          echo '<script>alert("Order Update Successfully");</script>';
          echo '<script>window.location.href = "outfordeliverylist.php";</script>';
      }
              ...
              <div class="col-12 col-sm-6 col-lg-4">
                <div class="card">
                  ...
                  <div class="form-group col-md-5">
                      ...
                      <select name="deliveryman" class="form-control selectric">
                      <?php
                      $query = "SELECT id,first_name FROM delivery_man";
                      $query_run = mysqli_query($conn, $query);
