...
<head>
  ...
  <title>Out For Delivery List</title>
  <!-- General CSS Files -->
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <?php
                                                  $no=1;
                                                    $queryuser="select orderId,userId,paymentStatus,finalTotal,address,orderStatus from orders where orderStatus=4 order by orderId desc";
                        ...
                        <tr>
                          ...
                          $fetch=mysqli_fetch_array(mysqli_query($conn,"select * from users where id='".$uid."'")); 
                          ?>
                          <td><?=$fetch['name'];?></td>
                          ...
                          ?></td>
                          <td><a href="outfordelivery.php?oid=<?=$data['orderId'];?>" class="btn btn-primary">Edit</a></td>
