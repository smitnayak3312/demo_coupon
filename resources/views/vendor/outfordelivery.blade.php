...
{  
   ...
   $orderStatus=trim($_POST['orderStatus']);
      ...
      if(mysqli_query($conn,$query))
      {
          ...
          echo '<script>window.location.href = "completedlist.php";</script>';
      }
      $getQuery = "SELECT * FROM orders where orderId='".$id."'";
                      $query_run = mysqli_query($conn, $getQuery);
                      $rowGet = mysqli_fetch_array($query_run);
                      $paymentStatusGet = $rowGet['paymentStatus'];
                      
    if($paymentStatusGet==1){           
      $querypaymentdate = "update orders set paymentDate=now() where orderId='".$id."'";
      mysqli_query($conn,$querypaymentdate);
    } 
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <tr>
                          ...
                          $fetch_product=mysqli_fetch_array(mysqli_query($conn,"select * from products where id='".$pid."'")); 
                          ?>
