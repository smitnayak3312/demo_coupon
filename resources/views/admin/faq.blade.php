...
{    
   $faq_que=trim($_POST['faq_que']);
   $faq_ans=trim($_POST['faq_ans']);

   $query = "insert into faq_table set faq_que='".$faq_que."',faq_ans='".$faq_ans."'";
   $final=mysqli_query($conn,$query);
   if($final)
   {
       echo '<script>alert("FAQ Add Successfully")</script>';
   }else{
                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="faq_que" class="form-control">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Answer</label>
                      <div class="col-sm-12 col-md-7">
                        <textarea class="summernote-simple" name="faq_ans"></textarea>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
