...
if(!isset($_SESSION['id']) || $_SESSION['id'] == "") 
 ...
 $getsliderQuery = "SELECT * FROM category WHERE id = '".$id."' ";
  ...
  if(mysqli_num_rows($getsliderResult) > 0){
    ...
    if($categoryImage != ''){
      $categoryImage = "image/category_image/".$categoryImage;
    }
...
{  
 ...
 // $result=$urlspd.$newname;
  ...
  { 
      ...
      $query = "update category set name='".$name."',is_popular='".$is_popular."'";
      if($newname != ''){
      $query .= ",image='".$newname."'";
    }
