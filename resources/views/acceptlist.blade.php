                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <?php
                                                  $no=1;
                                                    $queryuser="select orderId,userId,paymentStatus,finalTotal,address,orderStatus from orders where orderStatus=2 order by orderId desc";
                        ...
                        <tr>
                          ...
                          ?></td>
                          <td><a href="accept.php?oid=<?=$data['orderId'];?>" class="btn btn-primary">Edit</a></td>
