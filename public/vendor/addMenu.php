...
{  
 ...
 // $result=$urlspd.$newname;
  ...
  { 
      ...
      $query = "insert into menu set image='".$newname."',vendorId='".$_SESSION['id']."'";
      if(mysqli_query($conn,$query))
      {
          //copy($temp,"img/products/".$newname);
          echo '<script>alert("Menu Add Successfully");</script>';
          echo '<script>window.location.href = "menuList.php";</script>';
      }else{
          echo '<script>alert("Falied Try Again Later");</script>';
          echo '<script>window.location.href = "menuList.php";</script>';
      }
  }
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Add Menu</label>
