                ...
                <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <div class="form-group col-md-6">
                      ...
                      <input type="text" value="<?php echo $vendorData['vendor_name'];?>" readonly name="vendor_name"class="form-control">
                      </div>
                      <div class="form-group col-md-6">
                      <label>Mobile No</label>
                      <input type="number" value="<?php echo $vendorData['vendor_mobile'];?>" readonly name="vendor_mobile" class="form-control">
                      </div>
                      </div>
                      <div class="row">
                     <div class="form-group col-md-4">
                      <label>Email</label>
                      <input type="email" name="email" readonly value="<?php echo $vendorData['email'];?>" class="form-control">
                      </div>
