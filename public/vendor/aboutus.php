...
{    
  ...
  // $image=trim($_POST['image']);
   ...
   $query = "update vendors set about_us='".$about_us."' where id='".$_SESSION['id']."'";
    if(mysqli_query($conn,$query))
   {
       echo '<script>alert("About us update successfully");window.location.assign("aboutus.php")</script>';
   }else{
                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <textarea name="about_us" rows="5" cols="5" class="form-control" required><?=$fetch['about_us'];?></textarea>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
