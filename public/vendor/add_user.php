...
{    
   ...
   $query = "insert into coupon set vendorId='".$_SESSION['id']."',name='".$name."',description='".$description."',total_coupon='".$total_coupon."'";
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <div class="form-group col-md-6">
                      ...
                      <?php
                      $query = "SELECT * FROM user_subscription where status='1'";
                      $query_run = mysqli_query($conn, $query);

                      while ($row = mysqli_fetch_array($query_run)) {
                      echo "<option value='".$row['id'].",".$row['amount'].",".$row['description']."'>Plan Name :".$row['name']." || Plan amount:".$row['amount']." || Plan Description : ".$row['description']."</option>";
                      }
